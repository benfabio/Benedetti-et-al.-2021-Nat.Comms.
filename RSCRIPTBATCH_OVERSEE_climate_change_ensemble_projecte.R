...
### get all future monthly clims for every ESM, gather in a list from which you will get slices coming projection time 
future <- TRUE
ESMs <- c("CNRM-PISCES","IPSL-PISCES","GFDL-TOPAZ","CESM-BEC","MRI-NEMURO")		
setwd(paste("/net/kryo/work/fabioben/OVERSEE/data/future/MAREMIP_data/future_mon_clims", sep = ""))
# Pattern: clims_mon_Apr_,esm,_rcp85_base+2100-2031.txt    
# esm <- "IPSL-PISCES"
future_clims_ESMs <- lapply(ESMs, function(esm) {
            ...
            listMonths <- list()
    		future.jan <- read.table(paste("clims_mon_Jan_",esm,"_rcp85_base+2100-2031.txt", sep = ""), h = T, sep = "\t")
    		future.feb <- read.table(paste("clims_mon_Feb_",esm,"_rcp85_base+2100-2031.txt", sep = ""), h = T, sep = "\t")
    		future.mar <- read.table(paste("clims_mon_Mar_",esm,"_rcp85_base+2100-2031.txt", sep = ""), h = T, sep = "\t")
    		future.apr <- read.table(paste("clims_mon_Apr_",esm,"_rcp85_base+2100-2031.txt", sep = ""), h = T, sep = "\t")
    		future.may <- read.table(paste("clims_mon_May_",esm,"_rcp85_base+2100-2031.txt", sep = ""), h = T, sep = "\t")
    		future.jun <- read.table(paste("clims_mon_Jun_",esm,"_rcp85_base+2100-2031.txt", sep = ""), h = T, sep = "\t")
    		future.jul <- read.table(paste("clims_mon_Jul_",esm,"_rcp85_base+2100-2031.txt", sep = ""), h = T, sep = "\t")
    		future.aug <- read.table(paste("clims_mon_Aug_",esm,"_rcp85_base+2100-2031.txt", sep = ""), h = T, sep = "\t")
    		future.sep <- read.table(paste("clims_mon_Sep_",esm,"_rcp85_base+2100-2031.txt", sep = ""), h = T, sep = "\t")
    		future.oct <- read.table(paste("clims_mon_Oct_",esm,"_rcp85_base+2100-2031.txt", sep = ""), h = T, sep = "\t")
    		future.nov <- read.table(paste("clims_mon_Nov_",esm,"_rcp85_base+2100-2031.txt", sep = ""), h = T, sep = "\t")
    		future.dec <- read.table(paste("clims_mon_Dec_",esm,"_rcp85_base+2100-2031.txt", sep = ""), h = T, sep = "\t")
            # Add a month id
								...
								if(future == TRUE) {
                                    ...
                                    for(esm in ESMs) {
    									...
    									myBiomodProj <- BIOMOD_Projection(
    														...
    														proj.name = paste("projection",sp,"apr_2100_",esm, sep = "_"),
    														selected.models = 'all',
    														binary.meth = 'TSS',
    														compress = 'xz',
    														clamping.mask = FALSE 
    									...
    									myBiomodProj <- BIOMOD_Projection(
    														...
    														proj.name = paste("projection",sp,"jul_2100_",esm, sep = "_"),
    														selected.models = 'all',
    														binary.meth = 'TSS',
    														compress = 'xz',
    														clamping.mask = FALSE 
    									...
    									myBiomodProj <- BIOMOD_Projection(
    														...
    														proj.name = paste("projection",sp,"oct_2100_",esm, sep = "_"),
    														selected.models = 'all',
    														binary.meth = 'TSS',
    														compress = 'xz',
    														clamping.mask = FALSE 
    									...
    									myBiomodProj <- BIOMOD_Projection(
    														...
    														proj.name = paste("projection",sp,"jan_2100_",esm, sep = "_"),
    														selected.models = 'all',
    														binary.meth = 'TSS',
    														compress = 'xz',
    														clamping.mask = FALSE 
    									...
    									myBiomodProj <- BIOMOD_Projection(
    														...
    														proj.name = paste("projection",sp,"feb_2100_",esm, sep = "_"),
    														selected.models = 'all',
    														binary.meth = 'TSS',
    														compress = 'xz',
    														clamping.mask = FALSE 
    									...
    									myBiomodProj <- BIOMOD_Projection(
    														...
    														proj.name = paste("projection",sp,"mar_2100_",esm, sep = "_"),
    														selected.models = 'all',
    														binary.meth = 'TSS',
    														compress = 'xz',
    														clamping.mask = FALSE 
    									...
    									myBiomodProj <- BIOMOD_Projection(
    														...
    														proj.name = paste("projection",sp,"may_2100_",esm, sep = "_"),
    														selected.models = 'all',
    														binary.meth = 'TSS',
    														compress = 'xz',
    														clamping.mask = FALSE 
    									...
    									myBiomodProj <- BIOMOD_Projection(
    														...
    														proj.name = paste("projection",sp,"jun_2100_",esm, sep = "_"),
    														selected.models = 'all',
    														binary.meth = 'TSS',
    														compress = 'xz',
    														clamping.mask = FALSE 
    									...
    									myBiomodProj <- BIOMOD_Projection(
    														...
    														proj.name = paste("projection",sp,"aug_2100_",esm, sep = "_"),
    														selected.models = 'all',
    														binary.meth = 'TSS',
    														compress = 'xz',
    														clamping.mask = FALSE 
    									...
    									myBiomodProj <- BIOMOD_Projection(
    														...
    														proj.name = paste("projection",sp,"sep_2100_",esm, sep = "_"),
    														selected.models = 'all',
    														binary.meth = 'TSS',
    														compress = 'xz',
    														clamping.mask = FALSE 
    									...
    									myBiomodProj <- BIOMOD_Projection(
    														...
    														proj.name = paste("projection",sp,"nov_2100_",esm, sep = "_"),
    														selected.models = 'all',
    														binary.meth = 'TSS',
    														compress = 'xz',
    														clamping.mask = FALSE 
    									...
    									myBiomodProj <- BIOMOD_Projection(
    														...
    														proj.name = paste("projection",sp,"dec_2100_",esm, sep = "_"),
    														selected.models = 'all',
    														binary.meth = 'TSS',
    														compress = 'xz',
    														clamping.mask = FALSE 
...
for(p in pools) {
	...
	setwd(paste(WD,"/niche.modelling_future_",rcp,"_ensemble/",p,"/", sep = ""))
	second.wd <- getwd()
	setwd(WD)
